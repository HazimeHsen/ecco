          ...
          <div className="mx-auto ">
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg ">
              <div className="md:px-6 px-4 pb-8">
                ...
                <div className="mt-10 flex flex-wrap py-10 border-t border-blueGray-200 ">
                  <div className="md:w-1/2 w-full md:border-r border-b md:border-b-0 border-blueGray-200 ">
                    <EditForm
                      id={params.id}
                      images={images}
                      setUpdated={setUpdated}
